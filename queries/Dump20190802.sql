...
CREATE TABLE `hospitals` (
  ...
  `hospital_address` varchar(250) DEFAULT NULL,
  `hospital_longitude` float(11,8) DEFAULT NULL,
  `hospital_latitude` float(11,8) DEFAULT NULL,
  `hospital_description` varchar(250) NOT NULL,
  `hospital_mobile_number` varchar(15) DEFAULT NULL,
  `hospital_email` varchar(60) DEFAULT NULL,
  `license_category` varchar(60) DEFAULT NULL,
  `hospital_city_id` int(11) DEFAULT NULL,
  `md_name` varchar(30) NOT NULL,
  `md_contact_number` varchar(15) NOT NULL,
...
-- Dump completed on 2019-08-02  6:52:10
